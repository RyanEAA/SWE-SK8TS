...
function NewAboutMe(props) {
  ...
  return (
    ...
    <main className="individual-page">
        ...
        <div className="profile-container">
            ...
            <div className="polaroid">
                ...
                <div className="social-media">
                    ...
                    <a className="linkedin-button" href="https://www.linkedin.com/in/ryan-aparicio-547586220/">
                    LinkedIn
                    </a>
                </div>
            </div>
        ...
        {/* this is where photos are going to be shown*/}
        <div className="image-gallery">
            ...
            {/* If you have a third image/description */}
              {/* {props.interest3image && props.interest3desc && (
                <div className="polaroid">
                    <img src={props.interest3image} alt="interest 3" style={{height:'250px'}}/>
                    <p>{props.interest3desc}</p>
                </div>
              )} */}
